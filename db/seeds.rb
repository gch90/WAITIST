...
Application.create!(waiter: waiter_one, restaurant: all_restos[1], start_date: Date.new(2022,3,3), end_date: Date.new(2022,3,7), rating: 4, creator: waiter_one)
Application.create!(waiter: waiter_one, restaurant: all_restos[1], start_date: Date.new(2022,3,12), end_date: Date.new(2022,3,16), rating: 4, creator: waiter_one)
Application.create!(waiter: waiter_one, restaurant: all_restos[1], start_date: Date.new(2022,3,8), end_date: Date.new(2022,3,15), rating: 3, creator: all_restos[1])
Application.create!(waiter: waiter_one, restaurant: all_restos[1], start_date: Date.new(2022,3,16), end_date: Date.new(2022,3,22), rating: 3, creator: all_restos[1])
