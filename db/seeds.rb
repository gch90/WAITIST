...
p "creating users"
waiters = []
waiters << User.create!(user_role: 0, email: "g@g.g", password: "qwerty", first_name: "Georges", last_name: "Chami",
  address: "gohier st, Montreal",
  description: "Dedicated waiter with six years of exemplary service in the food service industry. Committed to providing
  helpful, fast, and accurate service to patrons. Demonstrate active listening and communication skills to ensure patrons
  are satisfied and happy. Experience in various settings, including family restaurants, bars, cafeterias, banquets,
  and room service. Comfortable serving patrons of various age ranges and backgrounds. Determined team player striving
  to deliver the highest quality service alongside food service staff.",
  summary: "Dedicated waiter with six years of exemplary service in the food service industry.
  Committed to providing helpful, fast, and accurate service to patrons. Demonstrate active listening and communication
  skills to ensure patrons are satisfied and happy. Experience in various settings, including family restaurants, bars,
  cafeterias, banquets, and room service. Comfortable serving patrons of various age ranges and backgrounds. Determined
  team player striving to deliver the highest quality service alongside food service staff.",
  phone: "555-514-1234",
  nickname: "George")
...
applications << Application.create!(waiter: waiters[8], restaurant: my_restos[0], creator: waiters[8], status: 1, start_time: Date.new(2022,2,28), end_time: Date.new(2022,3,2), rating: 4 )
...
applications << Application.create!(waiter: waiters[0], restaurant: my_restos[2], creator: waiters[0], status: 1, start_time: Date.new(2022,3,21), end_time: Date.new(2022,3,24), rating: 4 )
...
applications << Application.create!(waiter: waiters[0], restaurant: my_restos[4], creator: my_restos[4], status: 1, start_time: Date.new(2022,2,21), end_time: Date.new(2022,2,22), rating: 4 )
applications << Application.create!(waiter: waiters[1], restaurant: my_restos[1], creator: waiters[1], status: 1, start_time: Date.new(2022,2,23), end_time: Date.new(2022,2,25), rating: 4 )
