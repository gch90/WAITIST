...
Application.create!(waiter: waiter_two, restaurant: resto_two, start_date: Date.new(2022,3,8), end_date: Date.new(2022,3,15), rating: 3, creator: waiter_two)
Application.create!(waiter: waiter_two, restaurant: resto_two, start_date: Date.new(2022,3,16), end_date: Date.new(2022,3,22), rating: 3, creator: waiter_two)
Application.create!(waiter: waiter_three, restaurant: resto_three, start_date: Date.new(2022,3,3), end_date: Date.new(2022,3,7), rating: 5, creator: resto_three)
Application.create!(waiter: waiter_three, restaurant: resto_four, start_date: Date.new(2022,3,23), end_date: Date.new(2022,3,29),rating: 5, creator: waiter_three)
Application.create!(waiter: waiter_four, restaurant: resto_four, start_date: Date.new(2022,3,8), end_date: Date.new(2022,3,15), rating: 4, creator: resto_four)
Application.create!(waiter: waiter_four, restaurant: resto_four, start_date: Date.new(2022,3,17), end_date: Date.new(2022,3,23), rating: 4, creator: resto_four)
