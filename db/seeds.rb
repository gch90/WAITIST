...
applications << Application.create!(waiter: waiters[0], restaurant: my_restos[2], creator: waiters[0], status: 1, start_time: Date.new(2022,3,2), end_time: Date.new(2022,3,4), rating: 4 )
